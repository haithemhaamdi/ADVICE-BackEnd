...
using ADVICEService.ServiceManagmentImplementation;
using ADVICEService.ServiceManagmentInterface;

namespace ADVICE.NetCore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ADVICEData.IRepositoriesDAL.IBanqueRepository, ADVICEData.RepositoriesDAL.BanqueRepository>();
            services.AddScoped<ADVICEData.IRepositoriesDAL.IEmployeRepository, ADVICEData.RepositoriesDAL.EmployeRepository>();
            ...
            services.AddScoped<ADVICEData.IRepositories.IEmployeRepository, ADVICEData.Repositories.EmployeRepository>();
